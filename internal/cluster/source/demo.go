...
func initialSnapshot() domain.Snapshot {
	...
	return domain.Snapshot{
		...
		Services: []domain.Service{
			{ID: "gateway", Name: "Edge Gateway", Description: "Public ingress and request routing", Kind: "edge", Status: domain.StatusHealthy, Position: [3]float64{-4.2, 0.9, 0.5}, Latency: 18, Uptime: 99.99, RequestsPerMinute: 1842, ErrorRate: 0.03, Version: "nginx/1.27", Instances: []domain.Instance{instance("gateway-7db9f-2rk8m", 17), instance("gateway-7db9f-x9tq4", 19)}, Dependencies: []string{"api"}},
			{ID: "api", Name: "Core API", Description: "Authentication, incidents and cluster topology", Kind: "compute", Status: domain.StatusHealthy, Position: [3]float64{-1.3, 1.1, -0.2}, Latency: 32, Uptime: 99.97, RequestsPerMinute: 1396, ErrorRate: 0.08, Version: "neuro-api/0.1.0", Instances: []domain.Instance{instance("api-68f7d-k5jrm", 30), instance("api-68f7d-p82nc", 34)}, Dependencies: []string{"mongodb", "redis", "rabbitmq", "minio"}},
			{ID: "mongodb", Name: "MongoDB", Description: "Persistent cluster state and incident history", Kind: "database", Status: domain.StatusHealthy, Position: [3]float64{2.6, 2.25, -0.8}, Latency: 24, Uptime: 99.98, RequestsPerMinute: 884, ErrorRate: 0.01, Version: "mongo/7.0", Instances: []domain.Instance{instance("mongodb-0", 24)}, Dependencies: []string{}},
			{ID: "redis", Name: "Redis", Description: "Snapshots, cache and distributed locks", Kind: "cache", Status: domain.StatusHealthy, Position: [3]float64{2.8, 0.1, 0.9}, Latency: 7, Uptime: 99.99, RequestsPerMinute: 2234, ErrorRate: 0, Version: "redis/7.2", Instances: []domain.Instance{instance("redis-6dc8b-m2v7s", 7)}, Dependencies: []string{}},
			{ID: "rabbitmq", Name: "RabbitMQ", Description: "Cluster events and notification delivery", Kind: "queue", Status: domain.StatusHealthy, Position: [3]float64{-0.1, -2.15, -0.6}, Latency: 12, Uptime: 99.96, RequestsPerMinute: 428, ErrorRate: 0.02, Version: "rabbitmq/3.12", Instances: []domain.Instance{instance("rabbitmq-0", 12)}, Dependencies: []string{}},
			{ID: "minio", Name: "MinIO", Description: "Logs, screenshots and incident attachments", Kind: "storage", Status: domain.StatusHealthy, Position: [3]float64{3.4, -2.05, 0.15}, Latency: 41, Uptime: 99.95, RequestsPerMinute: 96, ErrorRate: 0.04, Version: "minio/2025.01", Instances: []domain.Instance{instance("minio-0", 41)}, Dependencies: []string{}},
		},
		Events: []domain.Event{
